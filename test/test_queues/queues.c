...
void producer_queue(struct k_msgq *queue, uint64_t *out_count, uint64_t *lost_count)
{
...
void producer_queue_polite(struct k_msgq *queue, uint64_t *out_count, uint64_t *lost_count)
{
...
void consumer_queue(struct k_msgq *queue, uint64_t *count)
{
...
void test_overflow_queue(void)
{
    ...
    thread_analyzer(100, (k_thread_entry_t)producer_queue, &queue, &produce_count, &lost_count,
                       K_PRIO_PREEMPT(3), K_MSEC(10), &produce_stats,
                       (k_thread_entry_t)consumer_queue, &queue, &consume_count, NULL,
                       K_PRIO_PREEMPT(2), K_MSEC(12), &consume_stats,
                       &elapsed_stats);

    // run_analyzer_split(100,
    //                    (k_thread_entry_t)producer_queue, &queue, &produce_count, &lost_count,
    //                    K_PRIO_PREEMPT(3), K_MSEC(10), &produce_stats,
    //                    (k_thread_entry_t)consumer_queue, &queue, &consume_count, NULL,
    //                    K_PRIO_PREEMPT(2), K_MSEC(12), &consume_stats,
    //                    &elapsed_stats);
...
void test_overflow_polite(void)
{
    ...
    thread_analyzer(100, (k_thread_entry_t)producer_queue_polite, &queue, &produce_count, &lost_count,
    ...
    // run_analyzer_split(100,
    //                    (k_thread_entry_t)producer_queue_polite, &queue, &produce_count, &lost_count,
    //                    K_PRIO_PREEMPT(4), K_MSEC(10), &produce_stats,
    //                    (k_thread_entry_t)consumer_queue, &queue, &consume_count, NULL,
    //                    K_PRIO_PREEMPT(3), K_MSEC(12), &consume_stats,
    //                    &elapsed_stats);
